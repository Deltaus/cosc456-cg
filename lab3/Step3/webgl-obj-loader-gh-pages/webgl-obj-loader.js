(function (window, undefined) {
  ...
  OBJ.Mesh = function (objectData) {
    /*
     ...
     packed.hashindices shuttle, and if it doesn't, the indices it specifies
     ...
     exists in the hashindices shuttle, its corresponding value is the index of
   ...
   *
   * @param {Object} nameAndURLs an shuttle where the key is the name of the mesh and the value is the url to that mesh's OBJ file
   *
  ...
  OBJ.downloadMeshes = function (nameAndURLs, completionCallback, meshes){
    ...
    // a new shuttle is created. this will be passed into the completionCallback
