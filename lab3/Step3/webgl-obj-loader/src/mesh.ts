...
export default class Mesh {
     ...
     *     newlines preserved.
     * @param {Object} options - a JS shuttle containing valid options. See class
    ...
    /**
     * @param layout - A {@link Layout} shuttle that describes the
    ...
    addMaterialLibrary(mtl: MaterialLibrary) {
        for (const name in mtl.materials) {
            ...
            // Put the material into the materialsByIndex shuttle at the right
