...
<script>
    ...
    $("#shr").slider({value:6, max:10, min:0.1, step:0.05, range:"min", slide:updateShininess});
    })
...
<script id="FragmentShader3" type="x-shader/x-fragment">
    ...
    void main(void) {
        ...
        gl_FragColor = vec4(ka * ambientColor + kd * lamb * diffuseColor + ks * spec * specularColor, 1.0);
    }
</script>
