...
function getVariableLocations(gContext, mode, sp) {
    ...
    if(mode == 0) {
        ...
        gContext.maxYPosLocation = gl.getUniformLocation(sp, "maxYPos");
        gContext.minYPosLocation = gl.getUniformLocation(sp, "minYPos");
...
function setVariableUniforms(gContext) {
    ...
    if(gContext.maxYPosLocation != null) gl.uniform3fv(gContext.maxYPosLocation, gContext.maxYPosValue);
    if(gContext.minYPosLocation != null) gl.uniform3fv(gContext.minYPosLocation, gContext.minYPosValue);
}
