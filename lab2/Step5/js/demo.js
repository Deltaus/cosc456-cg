...
GC.ambientColor = [1.0, 0.0, 0.0];
GC.diffuseColor = [0.8, 0.1, 0.1];
...
GC.maxYPosLocation = null;
GC.maxYPosValue = 0.0;
GC.minYPosLocation = null;
GC.minYPosValue = 0.0;
...
demo.prototype.init = function(){
    ...
    gl.clearColor(0.5,0.5,0.5,1.0);     //background to black
...
demo.prototype.initShaders = function(){
    ...
    //Load the shaders
    var fragmentShader = this.getShader("FragmentShader3");
    var vertexShader = this.getShader("VertexShader3");
    GC.mode = 2;
    ...
    getVariableLocations(GC, GC.mode, this.shaderProgram);
