...
GC.nMatrix = new Float32Array(16);//the Normal matrix
...
GC.ksLocation = null;
GC.shLocation = null;
GC.ambientColorLocation = null;
GC.diffuseColorLocation = null;
GC.specularColorLocation = null;
GC.lightPositionLocation = null;
//uniform init values
GC.lightPosition = [25.0, 1.0, 1.0];
GC.lightVec = new Float32Array(3);
GC.ambientColor = [0.2, 0.1, 0.3];
GC.diffuseColor = [0.5, 0.4, 0.8];
...
var lookAtMatrix_val = new Float32Array(16);
...
demo.prototype.init = function(){
    ...
    gl.clearColor(0.7,0.7,0.7,1.0);     //background to black
...
demo.prototype.initShaders = function(){
    ...
    //uniform location
    GC.kaLocation = gl.getUniformLocation(this.shaderProgram, "ka");
    GC.kdLocation = gl.getUniformLocation(this.shaderProgram, "kd");
    GC.ksLocation = gl.getUniformLocation(this.shaderProgram, "ks");
    GC.shLocation = gl.getUniformLocation(this.shaderProgram, "sh");
    GC.ambientColorLocation = gl.getUniformLocation(this.shaderProgram, "ambientColor");
    GC.diffuseColorLocation = gl.getUniformLocation(this.shaderProgram, "diffuseColor");
    GC.specularColorLocation = gl.getUniformLocation(this.shaderProgram, "specularColor");
    GC.lightPositionLocation = gl.getUniformLocation(this.shaderProgram, "lightPosition");
...
function drawScene(){
    ...
    GC.calNormMat = new matIV();
    GC.calNormMat.inverse(lookAtMatrix.flatten(), lookAtInv);
    GC.calNormMat.transpose(lookAtInv, GC.nMatrix);
...
//---------
    ...
    if(GC.kaLocation != null) gl.uniform1f(GC.kaLocation, GC.kaVal);
    if(GC.kdLocation != null) gl.uniform1f(GC.kdLocation, GC.kdVal);
    if(GC.ksLocation != null) gl.uniform1f(GC.ksLocation, GC.ksVal);
    if(GC.shLocation != null) gl.uniform1f(GC.shLocation, GC.shVal);
    if(GC.ambientColorLocation != null) gl.uniform3fv(GC.ambientColorLocation, GC.ambientColor);
    if(GC.specularColorLocation != null) gl.uniform3fv(GC.specularColorLocation, GC.specularColor);
    if(GC.lightPositionLocation != null) gl.uniform3fv(GC.lightPositionLocation, GC.lightPosition);
    if(GC.diffuseColorLocation != null) gl.uniform3fv(GC.diffuseColorLocation, GC.diffuseColor);
    //draw everything
